...
begin
  case opcode of
    ...
    $01,$02,$06,$08,$0a,$0e,$16,$1a,$1e,$21,$22,$26,
    $2a,$2e,$31,$32,$36,$3a,$40,$41,$42,$43,$44,$45,
    ...
    $77,$78,$79,$7a,$7b,$7c,$7d,$7e,$7f,$f8,$f9,$fa,
    $3e,$f2,$e0,$e2,$ea,$f0,$11,$12:begin
      load_opcode(opcode);
    end;
    $80,$81,$82,$83,$84,$85,$86,$87,$c6:begin
      add_opcode(opcode);
    end;
    $88,$89,$8a,$8b,$8c,$8d,$8e,$8f,$ce:begin
      adc_opcode(opcode);
    end;
    $90,$91,$92,$93,$94,$95,$96,$97,$d6:begin
      sub_opcode(opcode);
    end;
    $98,$99,$9a,$9b,$9c,$9d,$9e,$9f,$de:begin
      sbc_opcode(opcode);
    end;
    $a0, $a1, $a2, $a3, $a4, $a5, $a6, $a7, $e6:begin
      and_opcode(opcode);
    end;
    $a8, $a9, $aa, $ab, $ac, $ad, $ae, $af, $ee:begin
      xor_opcode(opcode);
    end;
    $b0, $b1, $b2, $b3, $b4, $b5, $b6, $b7, $f6:begin
      or_opcode(opcode);
    end;
    $b8, $b9, $ba, $bb, $bc, $bd, $be, $bf, $fe:begin
      cp_opcode(opcode);
    end;
    $c0, $c8, $d0, $d8:begin
      retcc_opcode(opcode);
    ...
    $d3, $db, $dd, $e3, $e4, $eb, $ec, $ed, $f4, $fc, $fd:begin
      //opcode not support!!!
    end;
    $c7, $cf, $d7, $df, $e7, $ef, $ff, $f7:begin
      rst_opcode(opcode);
    end;
    $cb00, $cb01, $cb02, $cb03, $cb04, $cb05, $cb06, $cb07:begin
      rlc_opcode(opcode);
    end;
    $cb08, $cb09, $cb0a, $cb0b, $cb0c, $cb0d, $cb0e, $cb0f:begin
      rrc_opcode(opcode);
    end;
    $cb10, $cb11, $cb12, $cb13, $cb14, $cb15, $cb16, $cb17:begin
      rl_opcode(opcode);
    end;
    $cb18, $cb19, $cb1a, $cb1b, $cb1c, $cb1d, $cb1e, $cb1f:begin
      rr_opcode(opcode);
    end;
    $cb20, $cb21, $cb22, $cb23, $cb24, $cb25, $cb26, $cb27:begin
      sla_opcode(opcode);
    end;
    $cb28, $cb29, $cb2a, $cb2b, $cb2c, $cb2d, $cb2e, $cb2f:begin
      sra_opcode(opcode);
    end;
    $cb30, $cb31, $cb32, $cb33, $cb34, $cb35, $cb36, $cb37:begin
      swap_opcode(opcode);
    end;
    $cb38, $cb39, $cb3a, $cb3b, $cb3c, $cb3d, $cb3e, $cb3f:begin
      srl_opcode(opcode);
    end;
    $cb40, $cb41, $cb42, $cb43, $cb44, $cb45, $cb46, $cb47, $cb48, $cb49, $cb4a, $cb4b,
    $cb4c, $cb4d, $cb4e, $cb4f, $cb50, $cb51, $cb52, $cb53, $cb54, $cb55, $cb56, $cb57,
    $cb58, $cb59, $cb5a, $cb5b, $cb5c, $cb5d, $cb5e, $cb5f, $cb60, $cb61, $cb62, $cb63,
    $cb64, $cb65, $cb66, $cb67, $cb68, $cb69, $cb6a, $cb6b, $cb6c, $cb6d, $cb6e, $cb6f,
    $cb70, $cb71, $cb72, $cb73, $cb74, $cb75, $cb76, $cb77, $cb78, $cb79, $cb7a, $cb7b,
    $cb7c, $cb7d, $cb7e, $cb7f:begin
      bit_opcode(opcode);
    end;
    $cb80, $cb81, $cb82, $cb83,$cb84, $cb85, $cb86, $cb87,$cb88, $cb89, $cb8a, $cb8b,
    $cb8c, $cb8d, $cb8e, $cb8f,$cb90, $cb91, $cb92, $cb93,$cb94, $cb95, $cb96, $cb97,
    $cb98, $cb99, $cb9a, $cb9b,$cb9c, $cb9d, $cb9e, $cb9f,$cba0, $cba1, $cba2, $cba3,
    $cba4, $cba5, $cba6, $cba7,$cba8, $cba9, $cbaa, $cbab,$cbac, $cbad, $cbae, $cbaf,
    $cbb0, $cbb1, $cbb2, $cbb3,$cbb4, $cbb5, $cbb6, $cbb7,$cbb8, $cbb9, $cbba, $cbbb,
    $cbbc, $cbbd, $cbbe, $cbbf:begin
      res_opcode(opcode);
    end;
    $cbc0, $cbc1, $cbc2, $cbc3,$cbc4, $cbc5, $cbc6, $cbc7,$cbc8, $cbc9, $cbca, $cbcb,
    $cbcc, $cbcd, $cbce, $cbcf,$cbd0, $cbd1, $cbd2, $cbd3,$cbd4, $cbd5, $cbd6, $cbd7,
    $cbd8, $cbd9, $cbda, $cbdb,$cbdc, $cbdd, $cbde, $cbdf,$cbe0, $cbe1, $cbe2, $cbe3,
    $cbe4, $cbe5, $cbe6, $cbe7,$cbe8, $cbe9, $cbea, $cbeb,$cbec, $cbed, $cbee, $cbef,
    $cbf0, $cbf1, $cbf2, $cbf3,$cbf4, $cbf5, $cbf6, $cbf7,$cbf8, $cbf9, $cbfa, $cbfb,
    $cbfc, $cbfd, $cbfe, $cbff:begin
      set_opcode(opcode);
    end;
//cur
...
function TGBCpu.pop_opcode(opcode: Integer): Integer;
begin
  case opcode of
    $F1:begin//POP AF  
      setReg_AF(popHelper);
