...
begin
  ...
  case address of
    ...
    $ff03 , $ff08 , $ff09 , $ff0a , $ff0b , $ff0c , $ff0d , $ff0e ,
    $ff15 , $ff1f , $ff27 , $ff28 , $ff29:begin
      ret := value or $FF;
    end;
  else
    ret := value;
...
begin
  ...
  end else if (pos >= $8000) and (pos <= $9fff) then
...
//        }
  ...
  else if (pos >= $A000) and (pos <=$BFFF) then begin
    _pMbc.MbcWrite(pos,val);
  end;
